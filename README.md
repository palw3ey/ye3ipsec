...
This project offers a comprehensive set of features for creating IPSec VPN connections and is designed for ease of use in both educational and practical applications, with default settings compatible with wide range of device like Cisco IOS, Fortigate, built in vpn clients (Windows, Android, iOS) and more
